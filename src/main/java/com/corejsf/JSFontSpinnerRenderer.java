...
public class JSFontSpinnerRenderer extends Renderer {
	...
	private Object getChangeScript(FacesContext context, UIInput component) {
		...
		ClientBehaviorContext behaviorContext = 
			ClientBehaviorContext.createClientBehaviorContext(context, component, "click", component.getClientId(context), null);
